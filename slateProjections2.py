    ...
    if tab == "2026 Projections":
        ...
        if group == "Hitters":
            ...
            if source_choice in ["MLB DW", "Steamer", "ATC","THE BAT", "OOPSY"]:
                ...
                cols_order = ["Player", "Team", "SRV","GS","IP","ERA","WHIP","K%","BB%","W","SV"]
                ...
                cols_order = ["Player", "Team", "Source", "IP", "SRV", "ERA", "WHIP", "SO", "W", "SV","GS", "H", "ER", "K/9", "BB/9", "K%", "BB%"]
                cols_order = ["Player","Team","Source","SRV","GS","IP","ERA","WHIP","K%","BB%","W","SV","SO","K/9","BB/9"]
